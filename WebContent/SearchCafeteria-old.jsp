...
<head>
        ...
        <title>CafeTeria| Search CafeTeria</title>
                                        ...
                                        <nav>
                                            <ul>
                                                ...
                                                <li ><a href="<%=request.getContextPath()%>/controller?actionCode=doGetListofItems" class=" col-xs-24">Food Menu</a>
                                                  ...
                                                  <!--<li class="active"><a href="cafeterialdetail?action=viewtable" class="col-xs-24">Cafeteria Details</a></li>-->
...
<input class="form-control" placeholder="Cafeteria Name" name="Cafeterianame"  type="text">
</div>
<input type="hidden" name="action" value="addtotable" />

<div class="reservation-page-input-box">
<input class="form-control" placeholder="Cafeteria Location" name="Cafeterialocation"  type="text">
</div>

<button type="submit" class="book-now-btn disabled">Add</button>                                    
...
<%				
				...
				<tr><td><%=materiallist1.get(i).getSr_no()%></td><td><%=materiallist1.get(i).getCafeName() %></td><td><%=materiallist1.get(i).getCafeLocation()%></td>
				<td><a href="cafeterialdetail?action=deltableentry&srno=<%=materiallist1.get(i).getSr_no()%>"/>Delete</a></td></tr>
				<%}} %>
