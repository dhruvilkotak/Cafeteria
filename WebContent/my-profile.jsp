                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                    <div class="logo-area">
                                        ...
                                        <!--<a href="#"><a href="index.html"><img class="img-responsive" src="img/cafeteria.jpg" alt="logo"></a></a> -->
                                    </div>
                                </div>
                                    ...
                                    <div class="main-menu-area">
                                        <nav>
                                            <ul>
                                                ...
                                                <li class="active"><a href="<%=request.getContextPath()%>/my-profile.jsp" class="col-xs-24"><%=session.getAttribute("fname") %></a></li>
                        ...
                        <div class="col-md-10 ">
                            <form class='form-horizontal' method='POST' action="<%= request.getContextPath()%>/AdminActions">
                                <fieldset>
                                    ...
                                    <!-- Form Name -->
                                    <h3>Edit User Profile <%= u.getName()%></h3>
                                    <!-- Text input-->
                                    <hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <!--<input type="button" name="login" class="btn btn-danger" value="Cancel">-->
                                            <!--<a href="#" class="btn btn-success" data-original-title="" title=""><span class="glyphicon glyphicon-thumbs-up"></span> Submit</a>-->
                                            <a href="<%=request.getContextPath()%>/controller?actionCode=doGetListofItems" class="btn btn-danger" value="" data-original-title="" title=""><span class=""></span> Cancel / Return to Menu</a>
                                        </div>
                                    </div>
