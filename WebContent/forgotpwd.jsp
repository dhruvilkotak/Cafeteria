...
<html class="no-js" lang="">
    ...
    <head>
        ...
        <title>CafeTeria | password reset</title>
                        ...
                        <div class="container">
                            <div class="row">                         
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                    <div class="logo-area">
                                        <span><h3>Request Password</h3></span>
            ...
            <div class="Signin-Box">
               <!-- <h2>Verification</h2><br> -->
                ...
                <form action="ForgotServlet" method="get">
                    ...
                    E-MAIL<input type="text" name="email" placeholder="Registered Email">
                    <input type="submit" name="login" class="login login-submit" value="Reset Password">
                </form>

                <div class="Reg-ForgotP">
                    <a href='login.jsp'>Login Page</a></center>
