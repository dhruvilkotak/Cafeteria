...
<head>
        ...
        <title>CafeTeria | Menu Management </title>
                                        ...
                                        <nav>
                                            <ul>
                                                ...
                                                <li ><a href="<%=request.getContextPath()%>/controller?actionCode=doGetListofItems" class=" col-xs-24">Food Menu</a>
                                                 ...
                                                 <!--<li class="active"><a href="Addfooditem.jsp" class="col-xs-24"> Menu Management</a></li>-->
...
<table align="center" >
 ...
 <td padding="5px"><input class="form-control" placeholder="Item Id " name="ItemId"  type="text"> </td>
</tr>

<tr>

<td> FOOD ITEM NAME: </td>
<td><input class="form-control" placeholder="Food Item Name " name="FoodItemName"  type="text"></td>
...
<td>ITEM CATEGORY:</td>
<td><input class="form-control" placeholder="Item Category" name="ItemCategory"  type="text"></td>
</tr>

<tr>
  <td>ITEM DESCRIPTION:</td>
<td><input class="form-control" placeholder="Item Description" name="ItemDescription"  type="text"></td>
</tr>

<tr>

<td>ITEM PRICE:</td>
<td><input class="form-control" placeholder="Item Price" name="ItemPrice"  type="text"></td>
</tr>

<tr>
<td>ITEM IMAGE:</td>
<td><input class="form-control" placeholder="Item Image" name="ItemImage"  type="file"></td>
</tr>
<tr>
...
<td></td>
<td><button type="submit" class="ghost-on-hover-btn" >Add</button></td>
